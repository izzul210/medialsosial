...
exports.signup = (req, res) => {
    ...
    //Extract valid and errors from validateSignupData
    //by passing newUser as input
...
exports.login = (req,res) => {
    ...
    //Extract valid and errors from validateLoginData
...
exports.uploadImage = (req,res) => {
    ...
    busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
        ...
        //eg: image.png => when want to know if its png or jpeg
        ...
        //Creating the file based on filepath
